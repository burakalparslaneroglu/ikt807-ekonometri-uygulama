"""Konu 10: yeniden örnekleme ile çıkarım — jackknife ve bootstrap.

Uygulama sekmesi ders notları §10.17'yi Hansen'in CPS verisiyle adım adım yeniden üretir. Sezgi
sekmesi bilinen bir veri üretim süreciyle üç kontrollü deney sunar; ilki notlardaki Tablo 10.1'i
birebir verir. Kendini sına sekmesi haftanın kavramlarını dört soru türüyle sınar.
"""
