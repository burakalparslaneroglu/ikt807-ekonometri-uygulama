"""Konu 09: regresyon süreksizliği tasarımı.

Uygulama sekmesi ders notları §9.15'i Hansen'in LM2007 (Head Start) verisiyle adım adım yeniden
üretir. Sezgi sekmesi bilinen bir veri üretim süreciyle üç kontrollü deney sunar. Kendini sına
sekmesi haftanın kavramlarını dört soru türüyle sınar.
"""
