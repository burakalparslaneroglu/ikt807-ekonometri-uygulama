...
TOPICS: tuple[TopicMetadata, ...] = (
    ...
    TopicMetadata(
        ...
        application_focus="LM2007 Head Start verisinde yerel doğrusal RDD, bant genişliği ölçeği ve duyarlılığı.",
        dataset_ids=("lm2007",),
    ...
    TopicMetadata(
        ...
        application_focus="Tam CPS örnekleminde (50.742) eğitim katsayısı için pairs bootstrap, HC1 ve percentile aralığı.",
        dataset_ids=("cps09mar",),
